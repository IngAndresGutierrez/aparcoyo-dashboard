...
import { DeleteReservaResponse } from "../types";
...
export const reservaService = {
  ...
  deleteReserva: async (id: string | number): Promise<DeleteReservaResponse> => {
    try {
        ...
        try {
          ...
          if (errorData.message) {
            ...
            if (errorData.message.includes('foreign key constraint') || 
              ...
              errorMessage = 'No se puede eliminar esta reserva porque tiene pagos asociados. Contacte al administrador.';
            } else {
